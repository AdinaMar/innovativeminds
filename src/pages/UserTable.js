...
import GlobalFilter from '../components/Users/activities/GlobalFilter'




const UserTable = ({users, isActive, setIsActive}) => {
...
<FaUserPlus className="add-user" onClick={() => setIsActive(!isActive)}/>  </Link>
